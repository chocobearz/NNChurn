...
```{r}
par(mfrow=c(2,2))
hist(OLS_Residuals, xlab='OLS Residuals', col='blue', xlim=c(-22,-0), ylim=c(0,6000), main='OLS Residuals', cex.main = 2)
hist(OLS_Residuals, xlab='OLS Residuals', col='blue', xlim=c(0,20),   ylim=c(0,2000), main='OLS Residuals', cex.main = 2)
hist(OLS_Residuals, xlab='OLS Residuals', col='blue', xlim=c(20,45),   ylim=c(0,25), main='OLS Residuals', cex.main = 2)
hist(OLS_Residuals, xlab='OLS Residuals', col='blue', xlim=c(40,400),   ylim=c(0,9), main='OLS Residuals', cex.main = 2)
hist(Standardized_Residuals, xlab='OLS Residuals', col='blue', xlim=c(-6,-0), ylim=c(0,5000), main='OLS Residuals', cex.main = 2)
hist(Standardized_Residuals, xlab='OLS Residuals', col='blue', xlim=c(0,6),   ylim=c(0,2000), main='OLS Residuals', cex.main = 2)
hist(Standardized_Residuals, xlab='OLS Residuals', col='blue', xlim=c(5,50),   ylim=c(0,13), main='OLS Residuals', cex.main = 2)
